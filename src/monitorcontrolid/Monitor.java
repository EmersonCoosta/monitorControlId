...
public class Monitor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(63, 63, 63)
                .addComponent(lblIp, javax.swing.GroupLayout.PREFERRED_SIZE, 288, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(42, 42, 42)
                .addComponent(lblIp, javax.swing.GroupLayout.PREFERRED_SIZE, 118, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    while (server.isBound()) {
                        ...
                        if (socket.isConnected()) {
                            ...
                            if (jsonObject.get("user_id") != null) {
                                ...
                                int idResult = event == 7 ? 1 : 2;

                                postFrequencia(user_id, timeStr, idResult, resultado);
                                try {
                                    acessoPassagem = (DadosAcessoPassagem(user_id));
                                    acesso();
    ...
    public void postFrequencia(int idPessoa, String ponto, int idMensagem, String mensagem) throws IOException {
        ...
        ponto = ponto.toString().replace(" ", "T") + "Z";
    ...
    public void acesso() throws FileNotFoundException, SQLException, ParseException {
        ...
        for (int i = 0; i < dados.size(); i++) {
            ...
            if (acessoPassagem) {
                ...
                controlId.updateInicialFinal(begin, begin, idPessoa);
            }
